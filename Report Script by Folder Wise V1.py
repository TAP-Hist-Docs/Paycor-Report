...
def searchAndUpload(dst_id, src_id):
    try:
        ...
        xpath = '/html/body/div[1]/div[2]/div[2]/div/div/div[2]/div/div[3]/div[1]/div[@class="style_documentFolder__k_Bmh"]/div[1]/div[1]'
        elements = driver.find_elements(By.XPATH,xpath)
        for folder_element in elements:
            time.sleep(1)
        ...
        if each_employee[0] :
            ...
            if not isDownloaded:
                ...
                if res == 0:
                        ...
                        cursor = SQLconnection.cursor()
                        sql_update = """UPDATE [HRG].[dbo].[Emp_Roster] SET [Reports] = ?
                        WHERE  [Employee_ID] =? ;"""
